...
# Load in data sets:
male_data <- read_excel("/Users/ksanaka/Desktop/Research/Osteomyelitis/Data/Osteomyelitis_Underlying_Sex_Mortality_Trend.xlsx", sheet = "Male")
female_data <- read_excel("/Users/ksanaka/Desktop/Research/Osteomyelitis/Data/Osteomyelitis_Underlying_Sex_Mortality_Trend.xlsx", sheet = "Female")
